...
@Entity
@Table(name = "deal_status") // Your SQL probably created "deals", but your entity is "deal_status". Ensure this matches.
public class DealStatus {
    ...
    /**
     * Field name is "agreementUploaded" (Java standard).
     * Column name "is_agreement_uploaded" matches your SQL.
     * Getter "isAgreementUploaded()" is auto-generated by Lombok or manually created.
     */
    @Column(name = "is_agreement_uploaded", nullable = false, columnDefinition = "BOOLEAN DEFAULT FALSE")
    private boolean agreementUploaded = false;

    /**
     * Field name is "registrationUploaded" (Java standard).
     * Column name "is_registration_uploaded" matches your SQL.
     * Getter "isRegistrationUploaded()" is auto-generated by Lombok or manually created.
     */
    @Column(name = "is_registration_uploaded", nullable = false, columnDefinition = "BOOLEAN DEFAULT FALSE")
    ...
    public enum DealStage {
        ...
        DealStage(int order) { this.order = order; }
    ...
    // ✅ NEW: Getters and Setters for document flags
