...
function Footer() {
    const [currentDateTime, setCurrentDateTime] = useState(getCurrentDateTimeIST());
    ...
    return (
        <footer style={styles.footer}>
            <div style={styles.contentGrid}>
                ...
                <div>
                    ...
                    <p style={styles.contactInfo}>
                        Your platform connecting property buyers and sellers exclusively in Hyderabad.
                    </p>
                    <div style={{marginTop: '20px'}}>
                        <h4 style={styles.columnTitle}>Support</h4>
                        <ul style={styles.linkList}>
                            <li style={styles.linkItem}><a href="/contact" style={styles.link}>Contact Us</a></li>
                            <li style={styles.linkItem}><a href="/faq" style={styles.link}>FAQ</a></li>
                ...
                <div>
                    ...
                    <ul style={styles.linkList}>
                        <li style={styles.linkItem}><a href="/area/Kondapur" style={styles.link}>Property in Kondapur</a></li>
                        <li style={styles.linkItem}><a href="/area/Gachibowli" style={styles.link}>Property in Gachibowli</a></li>
                        <li style={styles.linkItem}><a href="/area/Madhapur" style={styles.link}>Property in Madhapur</a></li>
                        <li style={styles.linkItem}><a href="/area/Jubilee_Hills" style={styles.link}>Property in Jubilee Hills</a></li>
                        <li style={styles.linkItem}><a href="/area/Banjara_Hills" style={styles.link}>Property in Banjara Hills</a></li>
                        <li style={styles.linkItem}><a href="/search?city=Hyderabad" style={styles.link}>View All Locations</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul style={styles.linkList}>
                        <li style={styles.linkItem}><a href="/loan" style={styles.link}>Home Loan Assistance</a></li>
                        <li style={styles.linkItem}><a href="/rental-agreement" style={styles.link}>Rental Agreement</a></li>
                        <li style={styles.linkItem}><a href="/owner-plans" style={styles.link}>Seller Plans</a></li>
                    </ul>
                    <h4 style={{...styles.columnTitle, marginTop: '20px'}}>Trusted Partners</h4>
                    <ul style={styles.linkList}>
                        <li style={styles.linkItem}><a href="/partner/furniture" style={styles.link}>Trusted Furniture Partner</a></li>
                        <li style={styles.linkItem}><a href="/partner/electrical" style={styles.link}>Trusted Electrical Contractor</a></li>
                        <li style={styles.linkItem}><a href="/home-renovation" style={styles.link}>Home Interior Experts</a></li>
                    </ul>
                </div>
                    ...
                    <div style={styles.bottomContactContainer}>
                        ...
                        <div>
                            ...
                            <div style={styles.appButtons}>
                                <a href="#" style={styles.appButton}>Google Play</a>
                                <a href="#" style={styles.appButton}>App Store</a>
                            </div>
                        </div>
            ...
            <div style={styles.copyright}>
                &copy; {new Date().getFullYear()} PropertyDealz. All rights reserved. | Serving Hyderabad.
