                ...
                <div style={bannerStyles.bannerContent}>
                    ...
                    <div style={bannerStyles.bannerFeatures}>
                        <div style={bannerStyles.bannerFeature}>
                            ...
                            <span><strong>No Subscription Required</strong> - Connect for free, no hidden charges</span>
                        </div>
                        <div style={bannerStyles.bannerFeature}>
                            <span style={bannerStyles.checkmark}>✓</span>
                            <span><strong>Buyer Connects to Agent</strong> - Direct connection, transparent communication</span>
                        </div>
                        <div style={bannerStyles.bannerFeature}>
                            <span style={bannerStyles.checkmark}>✓</span>
                            <span><strong>End-to-End Documentation</strong> - Agent handles all legal paperwork & registration</span>
                        </div>
                        <div style={bannerStyles.bannerFeature}>
                            <span style={bannerStyles.checkmark}>✓</span>
                            <span><strong>Only 0.5% Fee</strong> - Charged equally from both buyer and seller, that's it!</span>
                        </div>
                    </div>
                </div>
