...
function LoginPage() {
    ...
    const inputStyle = { width: '100%', padding: '8px', boxSizing: 'border-box', marginBottom: '1rem', borderRadius: '4px', border: '1px solid #ccc' };
    ...
    return (
        <div style={{ maxWidth: '400px', margin: '5rem auto', padding: '2rem', boxShadow: '0 0 10px rgba(0,0,0,0.1)', fontFamily: 'system-ui' }}>
            {step === 1 ? (
                <form onSubmit={handleRequestOtp}>
                    <h2>Login / Register</h2>
                    <p>Enter your mobile number to continue</p>
                    <div style={{ display: 'flex', marginBottom: '1rem' }}>
                        <span style={{ padding: '8px', border: '1px solid #ccc', background: '#f8f9fa', borderRadius: '4px 0 0 4px' }}>+91</span>
                        <input
                            type="tel" value={formData.mobileNumber} onChange={handleChange('mobileNumber')}
                            placeholder="10-digit mobile number" required maxLength="10"
                            style={{ flex: 1, padding: '8px', border: '1px solid #ccc', borderLeft: 'none', borderRadius: '0 4px 4px 0' }}
                        />
                    </div>
                ...
                <form onSubmit={handleVerifyOtp}>
                    ...
                    {isNewUser && (
                        <>
                            <p style={{fontSize: '0.9rem', color: '#555', fontWeight: '600'}}>Welcome! Please complete your registration.</p>
